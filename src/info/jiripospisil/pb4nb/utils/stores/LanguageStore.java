...
public class LanguageStore {
    ...
    public LanguageStore() {
        ...
        elements.add(new LanguageElement(new String[]{"text/xml","text/x-jsf+xml", "text/tomcat5+xml", "text/x-jnlp+xml", "text/x-maven-pom+xml", "text/x-springconfig+xml", "text/x-hibernate-reveng+xml", "text/x-hibernate-mapping+xml", "text/x-hibernate-cfg+xml", "text/x-dbschema+xml", "text/x-ant+xml"}, "xml", "XML"));
    }
